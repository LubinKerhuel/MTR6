...
pmsm.model          = 'ACT_Motor';      %           // Manufacturer Model Number
pmsm.sn             = '123456';         %           // Manufacturer Model Number
pmsm.p              = 4;                    %           // Pole Pairs for the motor
pmsm.Rs             = 0.2672;                %Ohm        // Stator Resistor
pmsm.Ld             = 1.35e-4;            %H          // D-axis inductance value
pmsm.Lq             = 1.35e-4;            %H          // Q-axis inductance value
pmsm.Lav            = (pmsm.Ld+pmsm.Lq)/2;  %H          // Average inductance
pmsm.Ke             = 6.3;               %Bemf Const	// Vline_peak/krpm
pmsm.Kt             = 0.066;                %Nm/A       // Torque constant
pmsm.J              = 170e-7;     %Kg-m2      // Inertia in SI units
pmsm.B              = 2.636875217824e-6;     %Kg-m2/s    // Friction Co-efficient
pmsm.I_rated        = 7.8*sqrt(2);   %A      	// Rated current (phase-peak)
pmsm.N_max          = 3700;           %rpm        // Max speed
pmsm.N_rated        = 3000;           %rpm        // rated speed
